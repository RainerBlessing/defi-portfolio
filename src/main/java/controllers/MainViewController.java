...
public class MainViewController {
    ...
    public void updateTransactionData() {
        ...
        try {
            ...
            myWriter.write("<html><body>"+settingsController.translationList.getValue().get("UpdateData").toString()+" </body></html>");
            myWriter.close();
        } catch (IOException e) {
...
*/
    ...
    public void finishedUpdate(){
        try {
            FileWriter myWriter = new FileWriter(settingsController.DEFI_PORTFOLIO_HOME + "update.portfolio");
            myWriter.write("<html><body>"+settingsController.translationList.getValue().get("PreparingData").toString()+"</body></html>");
            myWriter.close();
        } catch (IOException e) {
            settingsController.logger.warning("Could not write to update.portfolio."); }
    ...
    public void exportTransactionToExcel(List<TransactionModel> list, String filter) {
        ...
        if (selectedFile != null) {
            ...
            if (filter.equals("DAILY")) {
                ...
                success = this.expService.exportTransactionToCointracking(list, selectedFile.getPath(), localeDecimal, this.settingsController.selectedSeperator.getValue(), settingsController.exportCointracingVariante.getValue());
            }
    ...
    public void exportTransactionToExcel(TableView<TransactionModel> rawDataTable) {
        ...
        if(settingsController.exportCSVCariante.getValue().equals("Export selected to CSV")){
            ...
            filter = "";
        }else if(settingsController.exportCSVCariante.getValue().equals("Export all to CSV"))
        {
